...
import bookNow1 from "../../@core/assets/images/book-artist/1.jpg"
import bookNow2 from "../../@core/assets/images/book-artist/2.jpg"
import bookNow3 from "../../@core/assets/images/book-artist/3.jpg"
...
const Homepage = () => {
    ...
    console.log(allArtists,"check the all all artists")
    return (
        <>
                                                                ...
                                                                <div className="row align-items-center ">
                                                                    <div className="col-lg-12 mx-auto">
                                                                        <div className="usr-expert-pic-expert-info">
                                                                            <div className="row g-0">
                                                                                <div className="col-lg-6 col-6">
                                                                                    <Link to={`/services/${allArtists[index]?.featuredCategory ? allArtists[index]?.featuredCategory?.slug : allArtists[index]?.categories[0]?.slug}/${allArtists[index]?.userName}`} className="usr-expert-pic-name-box common-cursor-pointer btn w-100 text-start h-100">

                                                                                        <div className="text-layer">
                                                                                            <p className="usr-expert-pic-name">
                                                                                                {allArtists[index]?.profile?.fullName}
                                                                                            </p>
                                                                                            <span className="usr-expert-pic-profile">
                                                                                                {allArtists[index]?.featuredCategory?.title}
                                                                                            </span>
                                                                                        </div>
                                                                                    </Link>
                                                                                </div>
                                                                        ...
                                                                        <div className="expert-pic">
                                                                            <Link to={`/services/${allArtists[index]?.featuredCategory ? allArtists[index]?.featuredCategory?.slug : allArtists[index]?.categories[0]?.slug}/${allArtists[index]?.userName}`}>
                                                                        ...
                                                                        <div className="usr-expert-pic-insta-box">
                                                                            ...
                                                                            <a href={`https://www.instagram.com/${allArtists[index]?.instagram}`} target="_blank">
                                                                                {`https://www.instagram.com/${allArtists[index]?.instagram}`}
                                                                            </a>
                                                                        </div>
                                                                    </div>
                    ...
                    <div className="row mt-lg-4">
                        <div className="col-lg-4 col-md-4 ">
                            <div className="usr-package-card" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <img src={bookNow1} className="img-fluid " />
                                ...
                                <div className="usr-package-card-content">
                                    ...
                                    <button className="btn usr-book-now w-100">
                                        Book Now
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-4 ">
                            <div className="usr-package-card" data-aos="fade-up" data-aos-delay="500">
                                <div className="usr-package-card-icon">
                                <img src={bookNow2} className="img-fluid " />
                        ...
                        <div className="col-lg-4 col-md-4 ">
                            <div className="usr-package-card" data-aos="fade-up" data-aos-delay="800">
                                <div className="usr-package-card-icon">
                                <img src={bookNow3} className="img-fluid " />
                                            ...
                                            <div className="content">
                                                ...
                                                <div className="prizeButton">
                                                    ...
                                                    <div className="reserveButton">
                                                        <Link className="rButton btn" to={`/services/${allArtists[index]?.featuredCategory ? allArtists[index]?.featuredCategory?.slug : allArtists[index]?.categories[0]?.slug}/${allArtists[index]?.userName}`}>
                                                            <span className="me-1">
