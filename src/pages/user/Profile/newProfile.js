                            ...
                            <div className='usr-user-details'>
                                <div>
                                    ...
                                    <p>
                                        ...
                                        </svg>Speaks- English, Hindi and Punjabi
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div>
                                    ...
                                    <p>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="23" viewBox="0 0 18 23" fill="none">
                                            <path d="M6.72449 16.1719C6.54215 16.372 6.28383 16.5388 6.0559 16.5388C5.82797 16.5388 5.56965 16.3637 5.3797 16.1635L1.125 11.4932L2.47739 10.0087L6.06349 13.9451L15.5454 3.46191L16.875 4.97143L6.72449 16.1719Z" fill="#6D5D4C" />
                                        </svg>Identity
                                    </p>
                                    <p>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="23" viewBox="0 0 18 23" fill="none">
                    ...
                    <div className='usr-user-other-details'>
                        <div className='other-details'>
                            ...
                            <div className='details edit-button' type="button">
                                <h6>Edit Details</h6>
                                <p><svg xmlns="http://www.w3.org/2000/svg" width="20" height="23" viewBox="0 0 20 23" fill="none">
                                    <path d="M2.5 14.5501V17.0835C2.5 17.3168 2.68333 17.5001 2.91667 17.5001H5.45C5.55833 17.5001 5.66667 17.4585 5.74167 17.3751L14.8417 8.28346L11.7167 5.15846L2.625 14.2501C2.54167 14.3335 2.5 14.4335 2.5 14.5501ZM17.2583 5.8668C17.5833 5.5418 17.5833 5.0168 17.2583 4.6918L15.3083 2.7418C14.9833 2.4168 14.4583 2.4168 14.1333 2.7418L12.6083 4.2668L15.7333 7.3918L17.2583 5.8668Z" fill="#6D5D4C" />
                                </svg></p>
                            </div>
                        </div>
                    ...
                    <Slider {...settings}>
                        <div className='review-cards'>
                            <div className='review'>
                                <p>lorem isalncokenko ojnaofj koa iaehfoa aoh ojef haewjh oh oaho aoi fhoasn oah oano heoao ah oa</p>
