                        ...
                        <div className="col-lg-5">
                            <div className="usr-detail-card">
                                    ...
                                    <div className="usr-rating">
                                        <div className="usr-access-details">
                                            <div className="usr-address">
                                                <p>-{artistData?.address?.city ? artistData?.address?.city : null},{artistData?.address?.country ? artistData?.address?.country : null}</p>
                                            </div>
                                            {artistData?.travel ? 
                                ...
                                <div className="usr-artist-charges">
                                    <h6>Charges:</h6>
                                    <p><span>{artistData?.pricing?.totalPrice ? formatIndianRupee(artistData?.pricing?.totalPrice) : null}</span></p>
