                                                    ...
                                                    <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabIndex={0}>
                                                        ...
                                                        <div className="usr-artist-single-tab-content">
                                                            <p className="usr-artist-single-tab-content-heading">
                                                                About {artistData?.profile?.fullName ? artistData?.profile?.fullName : 'Artist'}
                                                            </p>
                                                            ...
                                                            <p className="usr-artist-single-tab-content-follow">
                                                                Follow {artistData?.profile?.fullName ? artistData?.profile?.fullName : 'Artist'}
                                                            </p>
                                                            <div className="usr-artist-single-tab-content-social-box">
                                                                <div className="usr-artist-single-tab-content-social-box-upper">
                                                                    ...
                                                                    </span> {artistData?.instagram ? artistData?.instagram : null}
                                                                </div>
                                                                <div className="usr-artist-single-tab-content-social-box-lower">
                                                                    <a href={`https://www.instagram.com/${artistData?.instagram ? artistData?.instagram : null}`} target="_blank" className="usr-artist-single-tab-content-social-box-lower-link">
                                                                        https://www.instagram.com/{artistData?.instagram ? artistData?.instagram : null}
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div className="usr-detail-card">
                                            <div className="usr-artist-details-tag">
                                                <div className="usr-name">
                                                    <h3>{artistData?.profile?.fullName ? artistData?.profile?.fullName : null}</h3>
