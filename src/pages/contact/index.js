                ...
                <div className="usr-contact-follow">
                  ...
                  <div className="usr-contact-menu">
                    <ul className="usr-contact-list-menu">
                      <li>
                        <a href="#">
                          <img src={instagram} alt="contact-social-icon" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src={facebook} alt="contact-social-icon" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src={twitter} alt="contact-social-icon" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src={linkedin} alt="contact-social-icon" />
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src={youtube} alt="contact-social-icon" />
                        </a>
                      </li>
                    </ul>
                  </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="usr-contact-text text-center">
                <p className="usr-contact-calendly-text-para">
                  SCHEDULE A MEETING
                </p>
              </div>
              <div className="row">
