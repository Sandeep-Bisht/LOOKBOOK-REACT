            ...
            <div class="row">
              <div class="col-md-6 usr-single-blogs-image">
                ...
                <div class="usr-single-blogs-social-icons">
                  ...
                  <Link to="" className="comments">{comments.length} Comments</Link>
                          ...
                          if (index < 2) {
                            return (
                              <div className="comments" key={index}>
                                <h6 className="comment-name">{`${comment.first_name} ${comment.last_name}`}</h6>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='row mb-3'>
                      <div className='col-md-6'>
                        <TextField variant="outlined" id="outlined-basic" label="firstname" {...register("first_name", { required: true })} fullWidth></TextField>
                        {errors.name && (<span style={{ color: "red" }}>This field is required</span>)}
                      </div>
                      <div className='col-md-6'><TextField variant="outlined" id="outlined-basic" label="lastname" {...register("last_name", { required: true })} fullWidth></TextField>
                        {errors.name && (<span style={{ color: "red" }}>This field is required</span>)}
                      </div> </div>
                    <TextField rows={5} variant="outlined" fullWidth multiline label="Write a comment....." defaultValue={""} {...register("comment", { required: true })} className='input-control' />
