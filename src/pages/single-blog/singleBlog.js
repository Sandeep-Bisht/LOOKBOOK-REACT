...
const SingleBlog = ()=> {
    ...
    return (
      ...
      <div className="row">
  <div className="col-md-6 usr-single-blogs-comments g-0">
    <h3>Comments</h3>
  ...
  <div className="col-md-6 usr-single-blogs-tags-recents-posts">
    <div className="tags">
      <h3>Tags</h3>
      <a href>Makeup trends</a>
      <a href>Makeup looks</a>
      <a href>Career</a>
      <a href>Professional MUA</a>
      <a href>Makeup artistry</a>
      <a href>Bridal makeup</a>
      <a href>Fashion makeup</a>
      <a href>MUA demand</a>
      <a href>Passion for beauty</a>
      <a href>Photoshoots</a>
      <a href>Ad campaign Shoot</a>
    </div>
        ...
        <div className="col-md-6">
          <div className="usr-recent-post-card">
            ...
            <div className="usr-recent-post-card-body">
              ...
              <p className="usr-recent-post-card-para">Lorem ipsum dolor, sit amet consectetur
                adipisicing elit.</p>
            </div>
