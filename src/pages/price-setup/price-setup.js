...
const SetupPrice = () => {
  ...
  const initialRows = artistServices && artistServices?.pricing && Array.isArray(artistServices?.pricing) && artistServices?.pricing.length > 0  && artistServices?.pricing.map((service, index) => ({
    id: index + 1,
